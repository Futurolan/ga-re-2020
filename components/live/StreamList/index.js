  ...
  render () {
    return (
      <div className='ga-stream-list'>
        {Object.keys(this.props.streams).length > 0 &&
          <div className='panel '>
              ...
              <div className='columns is-multiline'>
                {Object.keys(this.props.streams).map((i) => {
                  ...
                  if ((this.state.twitchStreams[stream.id] && this.state.twitchStreams[stream.id].id && this.state.twitchStreams[stream.id].online) || (this.state.youtubeStreams[stream.id] && this.state.youtubeStreams[stream.id].id && this.state.youtubeStreams[stream.id].online)) {
                    return (
                      <div className='thumbnail column is-4-tablet is-4-desktop is-3-widescreen ' key={i}>
                        {stream.type.id === 'stream_twitch' &&
                          <a title={this.state.twitchStreams[stream.id].status} href={`https://www.twitch.tv/${stream.id}`} target='_blank' rel='noopener noreferrer'>
                            <div className='image'>
                              ...
                              <div className='name has-text-white has-background-dark'> {this.state.twitchStreams[stream.id].display_name}&nbsp;|&nbsp;
                                <i className='fas fa-user' />&nbsp;{this.state.twitchStreams[stream.id].viewer_count}
                              </div>
                        ...
                        {stream.type.id === 'stream_youtube' &&
                          <a title={this.state.youtubeStreams[stream.id].status} href={`https://www.youtube.com/${stream.id}`} target='_blank' rel='noopener noreferrer'>
                            <div className='image'>
                              ...
                              <div className='name has-text-white has-background-dark'> {this.state.youtubeStreams[stream.id].display_name}&nbsp;|&nbsp;
                                <i className='fas fa-user' />&nbsp;{this.state.youtubeStreams[stream.id].viewer_count}
                              </div>
                              <div className='status has-text-white has-background-dark'>
                ...
                {Object.keys(this.props.streams).map((i) => {
                  ...
                  if ((this.state.twitchStreams[stream.id] && this.state.twitchStreams[stream.id].id && !this.state.twitchStreams[stream.id].online) || (this.state.youtubeStreams[stream.id] && this.state.youtubeStreams[stream.id].id && !this.state.youtubeStreams[stream.id].online)) {
                    return (
                      <div className='thumbnail column is-4-tablet is-4-desktop is-3-widescreen ' key={i}>
                        {stream.type.id === 'stream_twitch' &&
                          <a href={`https://www.twitch.tv/${stream.id}`} target='_blank' rel='noopener noreferrer'>
                            <div className='image'>
                        ...
                        {stream.type.id === 'stream_youtube' &&
                          <a href={`https://www.youtube.com/${stream.id}`} target='_blank' rel='noopener noreferrer'>
                            <div className='image'>
